...
def SpriteJogadorDireita():
    ...
    if DJ.DireitaJogador in range (0,4):
        return(pg.image.load('Componentes/Jogador/Recursos/Jogador_DireitaB.png'))
    if DJ.DireitaJogador in range (4,10):
        return(pg.image.load('Componentes/Jogador/Recursos/Jogador_Direita1B.png'))
    if DJ.DireitaJogador in range (10,14):
        return(pg.image.load('Componentes/Jogador/Recursos/Jogador_DireitaB.png'))
    if DJ.DireitaJogador in range (14,20):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Direita2B.png'))
def SpriteJogadorEsquerda():
    if DJ.EsquerdaJogador == 20:
        DJ.EsquerdaJogador = 0
    if DJ.EsquerdaJogador in range(0, 4):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_EsquerdaB.png'))
    if DJ.EsquerdaJogador in range(4, 10):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Esquerda1B.png'))
    if DJ.EsquerdaJogador in range(10, 14):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_EsquerdaB.png'))
    if DJ.EsquerdaJogador in range(14, 20):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Esquerda2B.png'))
def SpriteJogadorFrente():
    if DJ.AbaixoJogador == 20:
        DJ.AbaixoJogador = 0
    if DJ.AbaixoJogador in range(0, 4):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_FrenteB.png'))
    if DJ.AbaixoJogador in range(4, 10):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Frente1B.png'))
    if DJ.AbaixoJogador in range(10, 14):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_FrenteB.png'))
    if DJ.AbaixoJogador in range(14, 20):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Frente2B.png'))
def SpriteJogadorCostas():
    if DJ.AcimaJogador == 20:
        DJ.AcimaJogador = 0
    if DJ.AcimaJogador in range(0, 4):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_CostasB.png'))
    if DJ.AcimaJogador in range(4, 10):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Costas1B.png'))
    if DJ.AcimaJogador in range(10, 14):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_CostasB.png'))
    if DJ.AcimaJogador in range(14, 20):
        return (pg.image.load('Componentes/Jogador/Recursos/Jogador_Costas2B.png'))
